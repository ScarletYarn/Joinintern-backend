...
('ultra master', 'male', 2020, 1, '#', 'pass', 'admin', '超级管理员', '#', 1);
...
INSERT INTO post(post_title, duration, location, distanceZB, distanceMH, post_content, completed, expiration, author_id, start_time, end_time) VALUES
('程序员1', 30, '金沙江路10086号', 0.8, 1.6, '招聘程序员一名', false, '2020-2-1', 'openid_1', '2020-1-1', '2020-1-10'),
('程序员2', 60, '金沙江路10010号', 1.0, 1.8, '招聘程序员一名', false, '2020-1-1', 'openid_2', '2020-1-1', '2020-1-10'),
